...
\begin{tabular}{ll}
Field: & {\bfseries \@kierunek}\\
Specialisation: & {\bfseries \@specjalnosc}\\
\end{tabular}\\[1.3cm]
}
{\vskip 29pt\centering{\fontsize{24pt}{26pt}\selectfont%
{\fontsize{26pt}{28pt}\selectfont M}ASTER\\[7pt]
{\fontsize{26pt}{28pt}\selectfont T}HESIS}\\[2.5cm]
}
\vfill
{\centering
		{\fontsize{14pt}{16pt}\selectfont Supervisor}\\[2mm] %INFO: tutaj jest miejsce na nazwisko promotora pracy
...
%%  Thesis metadata 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Modelowanie i implementacja rÛønych warstw abstrakcji w systemach budowanych z wykorzystaniem standardu OPC UA}
\titleShort{Modeling and implementation of various abstraction layers in systems built using ...}
\titleEN{Modeling and implementation of various abstraction layers in systems built using the OPC UA standard}
\author{Jakub £oboda}
